            ...
            for (var i = files.length - 1; i >= 0; i--) {
                ...
                picReader.addEventListener("load", (function (i) {
                    return function (event) {
                        ...
                        div.innerHTML = "<input type='radio' style='height:100px' name='default_image_index' value=" + i + " ><img class='thumbnail' src='" + picFile.result + "'" +
                            "title='" + picFile.name + "'/>";
...
function updateProduct() {
    ...
    // todo check if all delete checkboxes are selected and no new images are uploaded and obstruct the user saying there should be at least one product image
